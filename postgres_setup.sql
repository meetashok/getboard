...
\COPY getboard.userinfo_stg FROM './data/userinfo.csv' WITH (FORMAT csv);
...
\COPY getboard.gamesinfo_stg FROM 'data/gamesinfo.csv' WITH (FORMAT csv);
...
\COPY getboard.gamecategories_stg FROM 'data/gamescategories.csv' WITH (FORMAT csv);
